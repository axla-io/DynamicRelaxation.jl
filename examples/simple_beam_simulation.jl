...
cb1 = PeriodicCallback(velocitydecay!, 1 * dt; initial_affect=true)

tol = 1e-5
ke_condition(u, t, integrator) = ke_condition(u, t, integrator, tol, vcat(v_ids, ω_ids))
cb2 = ContinuousCallback(ke_condition,velocityreset!)
